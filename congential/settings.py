"""
Django settings for congential project.
...
SECRET_KEY = 'django-insecure-o34jz3nsf5xxcq0v*en&&qr%m_5b=m@+mg@iar(^+h1x%vl4-#'
...
WSGI_APPLICATION = 'congential.wsgi.application'
